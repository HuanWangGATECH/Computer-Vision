...
def find_markers(image, template=None):
    ...
    # img_canny = cv2.Canny(img_temp,120,10)
    # cv2.imshow('img_temp_gray', img_canny)
    # circles = cv2.HoughCircles(img_canny, cv2.HOUGH_GRADIENT,1, 50,  param1 = 20,param2 = 5,minRadius = 5,maxRadius = 30)
    # print(circles)
    # for circle in circles[0,:]:
    # result1 = cv2.matchTemplate(img_temp, template, cv2.TM_CCOEFF_NORMED)
    # template2 = np.rot90(template)
    # result2 = cv2.matchTemplate(img_temp, template2, cv2.TM_CCOEFF_NORMED)
    findmax = 0
...
def draw_box(image, markers, thickness=1):
    ...
    """
    img_temp = np.copy(image)
    cv2.line(img_temp,(markers[0][0],markers[0][1]),(markers[1][0],markers[1][1]),color=(0,50,255),thickness=thickness)
    cv2.line(img_temp,(markers[1][0],markers[1][1]),(markers[3][0],markers[3][1]),color=(0,50,255),thickness=thickness)
    cv2.line(img_temp,(markers[3][0],markers[3][1]),(markers[2][0],markers[2][1]),color=(0,50,255),thickness=thickness)
    cv2.line(img_temp,(markers[0][0],markers[0][1]),(markers[2][0],markers[2][1]),color=(0,50,255),thickness=thickness)
